...
def get_phishing_results(test_urls):
    ...
    # Use features of the first URL for prediction
    feature_input = results[test_urls[0]]
    result = predict_url_features(feature_input)
